...
function nodesRouterFactory (
     ...
     * @apiGroup nodes
     * @apiParam {String} identifier node identifier
     * @apiSuccess {json} sshSettings The list of sshSettings that the node with
     *                    <code>identifier</code> has.
     * @apiError NotFound1 The node with the <code>identifier</code> was not found.
    ...
    /**
     * @api {post} /api/1.1/nodes/:identifier/ssh/test POST /:id/ssh/test
     * @apiVersion 1.1.0
     * @apiDescription Test an SSH connection to the node
     * @apiName node-ssh-identify-post
     * @apiGroup nodes
     * @apiParam {String} identifier node identifier
     * @apiError NotFound The node with the <code>identifier</code> was not found.
     * @apiErrorExample {json} Error-Response:
    ...
    router.post('/nodes/:identifier/ssh/identify', rest(function (req) {
        return nodeApiService.testNodeSshById(req.params.identifier);
    }));
